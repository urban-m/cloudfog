Code for “Foggy connections: on the (non-)adaptation of lexical
structures”, Frontiers in Psychology
================
Matthias Urban
2022-12-05
...
“Foggy connections: on the (non-)adaptation of lexical structures”.
...
• IDS data in files “forms.csv” and “languages.csv” Available from the
CLDF dataset for IDS at: <https://zenodo.org/record/5547908>

• South American dataset in file “cloudfog SA data and sources.csv”
...
```
    ...
    ## 
    ## Group-Level Effects: 
    ## ~Family2 (Number of levels: 13) 
    ##                             Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    ## sd(Intercept)                   2.02      1.57     0.09     5.88 1.00     5468
    ## sd(LogElevation)                0.50      0.38     0.02     1.46 1.00     2180
    ## cor(Intercept,LogElevation)    -0.07      0.58    -0.95     0.95 1.00     2793
    ##                             Tail_ESS
    ## sd(Intercept)                   6709
    ## sd(LogElevation)                5314
    ## cor(Intercept,LogElevation)     6156
    ## 
    ## Population-Level Effects: 
    ##              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept        4.77      2.61    -0.14    10.21 1.00    15011    11438
    ## LogElevation    -0.80      0.46    -1.74     0.04 1.00    11996     9889
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
##### Compute Bayes Factor
    ...
    ## Estimated Bayes factor in favor of SA_databinarymodel over SA_databinarynnullmodel: 0.56136
...
```
    ...
    ## t = -125.17, df = 15523, p-value < 2.2e-16
